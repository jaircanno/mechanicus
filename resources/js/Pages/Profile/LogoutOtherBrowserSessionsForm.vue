   ...
   <jet-action-section>
     ...
     <template #content>
       <div class="max-w-xl text-sm text-gray-600">
         Si es necesario, puede cerrar la sesión de todas las demás sesiones de su navegador en todos sus dispositivos.
           ...
           <div class="ml-3">
             ...
             <div>
               <div class="text-xs text-gray-500">
                 ...
                 <span v-else>Última vez en linea {{ session.last_active }}</span>
               </div>
             </div>
           </div>
         </div>
